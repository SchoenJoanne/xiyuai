...
```bash
# 1. 拉代码到 /opt
sudo git clone https://github.com/xiyuailove/xiyuai.git /opt/xiyu-ai
...
完整的生产部署 walkthrough（监控接入 / 多实例 / 日志切割）正在写，跟踪 [Issue #5](https://github.com/xiyuailove/xiyuai/issues/5)。
...
A fuller production-deployment walkthrough (monitoring, multi-instance, log rotation) is being drafted — tracked in [Issue #5](https://github.com/xiyuailove/xiyuai/issues/5).
