...
### 仓库
- 本地：`<本地检出>`
- GitHub：`https://github.com/xiyuailove/xiyuai`
- 默认分支：`main`
...
### 目标
让外部用户能直接 `docker pull ghcr.io/xiyuailove/xiyuai:1.4.0` 上手。
...
- 本地 smoke：
  ```
  docker run -p 3000:3000 -v xiyu-data:/app/data ghcr.io/xiyuailove/xiyuai:1.4.0
  ```
...
## 升级
docker pull ghcr.io/xiyuailove/xiyuai:1.4.0
（自带 ffmpeg）
```
