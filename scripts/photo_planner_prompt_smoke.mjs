...
const COMPANION = { id: 1, name: '小溪', age: 22, current_scene: '在家', current_mood: 'happy', clothing_style: '甜美' };   // age:22 明确成年（v1.23 步① fail-closed：无 age 会被钳中性·成年 companion 必须带有效 age）
