...
export const REALISTIC_SKIN_TERMS = [
  ...
  // v1.23.2：反"网红塑料感/标准化网红脸"——真实好看的普通人，非 AI 审美模板。高颜值与真实感并存。
  'authentic candid photo of a real ordinary attractive person, natural and relatable, not a standardized influencer or beauty-filter face',
];
